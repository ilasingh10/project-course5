...
public class UserController {
    ...
    public ResponseEntity<SigninResponse> userSigin(@RequestHeader("authorization") final String authorization) throws AuthenticationFailedException {

        String[] authHeader = authorization.split("Basic ");
        byte[] decode = Base64.getDecoder().decode(authHeader[1]);
